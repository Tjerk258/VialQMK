...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT_96_ansi(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL, KC_HOME, KC_END, KC_PAGE_UP, KC_PAGE_DOWN, KC_MEDIA_PLAY_PAUSE,
    ...
    [1] = LAYOUT_96_ansi(
        ...
        _______,          _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______, _______,  _______,         _______, _______,            RGB_SPI,      _______,      _______, _______,
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    if (host_keyboard_led_state().num_lock) {
        RGB_MATRIX_INDICATOR_SET_COLOR(NUM_LOCK_LED_INDEX, 255, 255, 255); // assuming caps lock is at led #5
    } else {
